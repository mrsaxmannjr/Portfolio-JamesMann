...
const About = () => (
  <TheAbout>
    ...
    <div>
      ...
      <p>In addition to performing, I have also supported the Colorado music scene through education.  I ran a private lesson studio, I have been a guest instructor for middle and high schools as well as a guest clinician.  My passion for teaching has extended into the developer community as well.  I am a co-organiser of Learn to Code at Galvanize, a weekly 2 hour class where I teach basic HTML, CSS and JavaScript.  I am a Teaching Assstant for the JavaScript Accelerated course at Galvanize as well.  A classmate and I developed a weekly JavaScript whiteboard practice session to help with interview preparation we call Beer Boarding.  Lastly, I co-developed and taught a 3 hour course on HTML, CSS and Materialize for Brunch and Learn as well as a 3 part JavaScript for Beginners course that runs for 4 hours on Saturdays.</p>
